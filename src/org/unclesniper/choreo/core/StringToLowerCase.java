...
@ElementClass("stringToLowerCase")
public class StringToLowerCase extends AbstractStringOperation implements ChoreoExpr<String> {

	private ChoreoExpr<Locale> locale;

	public StringToLowerCase() {}

	public StringToLowerCase(ChoreoExpr<String> string, ChoreoExpr<Locale> locale) {
		super(string);
	...
	public String evaluate(RunContext context) throws ChoreoRunException {
		...
		if(elocale == null)
			...
			return estring.toLowerCase(elocale);
	}
